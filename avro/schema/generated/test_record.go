...
const TestRecordAvroCRC64Fingerprint = "=\x9bI\bp\xeb\xe2\x10"
...
func (_ TestRecord) HintSize(int)                     { panic("Unsupported operation") }
...
func (r TestRecord) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *TestRecord) UnmarshalJSON(data []byte) error {
